...
public class XMLtoDB {
	...
	public static void main(String[] args) {
		try {
			// TODO: Diasumsikan file diambil dari WEB
			String url = "http://localhost:8080/Collection/Task.xml";

			// TODO: Membuat document baru
			DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
			DocumentBuilder db = dbf.newDocumentBuilder();

			// TODO: Document akan diisi dari url web
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				// TODO: Node nNode adalah item nlist(record) yang berisi temp (perhitungan)
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					//TODO: dapatkan semua element tag untuk isi dari record (isinya dari url)
